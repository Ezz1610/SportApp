        ...
        do {
            ...
            return results.map { obj in
                League(
                    ...
                    country_key: obj.value(forKey: "countryKey") as? Int ?? 0,
                    country_name: obj.value(forKey: "countryName") as? String ?? "",
                    league_surface: obj.value(forKey: "leagueSurface") as? String ?? "",
